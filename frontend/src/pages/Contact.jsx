      ...
      <section className="relative pt-40 pb-12 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <p className="mt-6 max-w-xl text-white/65 text-lg">
            A short brief is enough. We respond within 24 hours with a clear next step.
          </p>
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          <div className="lg:col-span-4 space-y-5">
            ...
            <div className="glass rounded-2xl p-6">
              ...
              <p className="mt-3 mono-label">Phone</p>
              <a href="tel:+14155551234" className="mt-1 block text-white">+1 (415) 555-1234</a>
            </div>
            <div className="glass rounded-2xl p-6">
